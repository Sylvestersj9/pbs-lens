...
export const BEHAVIOUR_CODES: CodeDefinition[] = [
  ...
  { code: 'PD', label: 'Property Damage', description: 'Breaking, snapping, tearing or damaging property including TVs, laptops, phones, mirrors, fixtures and furniture. Often serves a sensory regulatory function rather than aggressive intent.' },
  { code: 'AB', label: 'Absconding', description: 'Running away from staff or premises; climbing out of secure areas; opportunistic flight toward a preferred destination.' },
